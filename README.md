...
## 📍 API 요약
> 자세한 API 명세는 링크를 확인해 주세요! [API 명세서 Link](https://blossom-fisherman-fd5.notion.site/1bc293e08aa2809dae58cdde20713eea)
- **Method**: POST
- **Endpoint**: /predict
...
|---|---|
|medias|업로드 할 미디어 파일|
|mediasMeta|업로드 할 미디어 파일들의 메타데이터 타입|
|categories|사용자 check 카테고리 정보|
|description|피드 내용|
- **Response(예시)**
```
{
    ...
    "description": "악플러들 다 죽었으면 좋겠다\n오늘은 날씨가 참 좋다",
    "censuredSentences": [
        {
            "text": "악플러들 다 죽었으면 좋겠다",
            "censured": true
        },
        {
            "text": "오늘은 날씨가 참 좋다",
    ...
    "results": [
        {
            ...
            "resultObject": "alcohol, cigarette",
            "timeline": {
                "cigarette": [
                    {
                        "start": 0.23,
